...
const foods = [
  ...
  {id:'coconut-chicken',name:'椰子鸡火锅',cuisine:'火锅',image:foodImage.hotpot,hint:'清甜暖胃，不想吃辣也合适',reason:'汤底清爽温和，累的时候吃起来没有负担。',tags:['light','friends','tired']},
  ...
  {id:'bibimbap',name:'石锅拌饭',cuisine:'韩餐',image:foodImage.korean,hint:'一锅拌匀，简单又满足',reason:'主食、蔬菜和肉都有，想省心时很合适。',tags:['casual','tired','light']},
  ...
  {id:'rice-noodles',name:'酸汤米线',cuisine:'面 / 粉',image:foodImage.noodles,hint:'酸香轻快，胃口马上回来',reason:'汤粉顺口又开胃，想吃点带劲但不厚重的就选它。',tags:['spicy','casual']},
  {id:'chicken-rice',name:'照烧鸡排饭',cuisine:'米饭套餐',image:foodImage.korean,hint:'一份套餐，解决今天的纠结',reason:'肉、饭和配菜组合完整，是稳妥又省心的一餐。',tags:['casual','tired']},
  {id:'claypot-rice',name:'腊味煲仔饭',cuisine:'米饭套餐',image:foodImage.korean,hint:'锅巴焦香，越吃越满足',reason:'米饭吸满腊味香气，适合今天想吃得扎实一点。',tags:['casual','premium']},
  ...
  {id:'roujiamo',name:'肉夹馍配凉皮',cuisine:'西北菜',image:foodImage.barbecue,hint:'碳水与肉香的快乐组合',reason:'方便、实在又有层次，想随便吃点时很合拍。',tags:['casual']},
  ...
  {id:'pho',name:'越南牛肉河粉',cuisine:'东南亚菜',image:foodImage.southeastAsian,hint:'清亮鲜香，吃完很轻松',reason:'香草与清汤让味道很舒展，适合清淡一点。',tags:['light','tired']},
  {id:'dumplings',name:'鲜肉锅贴',cuisine:'小吃',image:foodImage.barbecue,hint:'脆底多汁，小份也有满足感',reason:'想快速解决一餐，又不想太随便时就选它。',tags:['casual']},
  {id:'jianbing',name:'煎饼果子',cuisine:'小吃',image:foodImage.barbecue,hint:'熟悉的街头香气，简单可靠',reason:'出餐快、价格友好，适合不想走远的忙碌时刻。',tags:['casual']},
  ...
  {id:'fried-chicken',name:'脆皮炸鸡',cuisine:'汉堡快餐',image:foodImage.burger,hint:'今天就允许自己放纵一下',reason:'酥脆外皮很解压，适合想轻松吃顿快乐餐。',tags:['friends','tired']},
  {id:'chicken-salad',name:'香草鸡肉沙拉',cuisine:'轻食',image:foodImage.light,hint:'清爽有蛋白，下午也轻盈',reason:'蔬菜和鸡肉搭配均衡，适合想吃清淡一点。',tags:['light','premium']},
  ...
  {id:'eggs-benedict',name:'班尼迪克蛋',cuisine:'Brunch',image:foodImage.dessert,hint:'把普通一天过得松弛一点',reason:'流心蛋与面包很有周末气氛，适合今天想吃好一点。',tags:['premium','light']},
  {id:'avocado-toast',name:'牛油果吐司',cuisine:'Brunch',image:foodImage.light,hint:'轻盈、漂亮，也很舒服',reason:'清新的口感很适合慢下来享受一顿早午餐。',tags:['light','premium']},
...
const cuisineMeta = [
  ...
  ['米饭套餐','RICE SET',foodImage.korean,'鸡排饭 · 煲仔饭 · 盖饭'],
  ['西北菜','NORTHWEST',foodImage.barbecue,'大盘鸡 · 肉夹馍 · 凉皮'],
  ['东南亚菜','SOUTHEAST ASIA',foodImage.southeastAsian,'咖喱 · 河粉 · 香草'],
  ['小吃','SNACKS',foodImage.barbecue,'锅贴 · 煎饼 · 街头味'],
  ['汉堡快餐','BURGERS',foodImage.burger,'汉堡 · 炸鸡 · 快乐碳水'],
  ['轻食','LIGHT FOOD',foodImage.light,'沙拉 · 波奇饭 · 清爽'],
  ['家常菜','HOME STYLE',foodImage.warm,'番茄炒蛋 · 红烧肉'],
  ['Brunch','BRUNCH',foodImage.dessert,'吐司 · 班尼迪克蛋'],
...
function chooseFood(cuisine = selectedCuisine){
  ...
  const matching = foods.map((food,index) => ({food,index})).filter(({food}) => !cuisine || food.cuisine === cuisine);
  ...
  if(weighted.length > 1 && next === foodIndex) next = weighted.find(index => index !== foodIndex) ?? next;
  return next;
}
